                                    ...
                                    <div class="flex items-center">
                                        <div class="mr-2">
                                            @switch($ticketn->fk_status)
                                                ...
                                                @break
                                                @case('2')
                                                        <span class="bg-blue-200 text-blue-600 py-1 px-3 rounded-full text-xs">Em Negociação</span>
                                                @break
                                                @case('3')
                                                        <span class="bg-red-200 text-red-600 py-1 px-3 rounded-full text-xs">Em Complementação</span>
                                                @break
                                                @case('4')
